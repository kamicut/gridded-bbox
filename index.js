...
var map = L.mapbox.map('map', 'mapbox.light').setView([10,10],5);
var polys = {
...
var grid = turf.squareGrid(extent, 1, 'degrees');
...
var extentLayer = L.geoJson(polys).eachLayer(function(layer) {
  layer.setStyle(layer.feature.style);
});
